...
# --------------------------------------------
        ...
        ycross = self.dropout(self.crossattention1(y_cross, enc_out, enc_out, attn_mask=None)[0])
        y_cross = y_cross + ycross

        encross = self.dropout(self.crossattention1(enc_out, y_cross, y_cross, attn_mask=None)[0])
